 ...
 * Used for confirmations, forms, and other overlay content.
 *
 * Key features:
...
/**
 * DialogOverlay
 * The dark backdrop that appears behind the dialog
 */
...
/**
 * DialogContent
 * The actual dialog panel that contains the content
 */
