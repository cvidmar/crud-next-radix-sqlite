 ...
 * Radix UI provides unstyled, accessible components that we can style ourselves.
 *
 * Why Radix UI?
 * - Fully accessible (keyboard navigation, screen readers, ARIA attributes)
 * - Unstyled (we have full control over appearance)
 * - Well-tested and maintained
 * - Production-ready patterns
 *
 * This component demonstrates how to wrap Radix primitives with our styling.
 */
...
/**
 * Select Root
 * The main container component that holds all select parts
 */
const Select = SelectPrimitive.Root;

/**
 * SelectGroup
 * Used to group select options (like <optgroup> in HTML)
 */
...
/**
 * SelectContent
 * The dropdown panel that appears when select is opened
 */
